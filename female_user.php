  ...
  <div class="main-content">
    ...
    <div class="table-responsive">
      <table id="ex_table" class="table table-bordered">
        ...
        <tbody>
          <?php
          $user_query = "SELECT * FROM female_user ORDER BY `user_id` DESC";
          ...
          foreach ($user_result as $user) { ?>
            ...
            $hobbies_query = "SELECT * FROM female_hobbies Where user_id = '$user_id'";
...
<td><?php while($hobbies = mysqli_fetch_assoc($hobbies_result)){echo $hobbies['hoby_name'].',';}?></td>
            ...
            <td><img src='user_images/" .<?php $user['profile_img'] ?>"' alt='User Image' style='max-width: 100px;'></td>
          </tr>
        <?php  }
          ?>
        </tbody>
